...
SRC = \
	...
	src/Application.c \
	src/Fade.c src/Filter.c \
	src/Title.c \
	src/Logo.c src/Starter.c \
	src/Game.c \
	src/Back.c src/You.c src/Magic.c src/Rival.c src/Cat.c src/Crystal.c src/Status.c src/Announce.c src/Notice.c
